...
with autocast_ctx:
    ...
    # Monkeypatch prepare.EVAL_TOKENS to reduce eval from 2.6M to 0.5M tokens (~100 steps)
    import prepare
    original_eval_tokens = prepare.EVAL_TOKENS
    prepare.EVAL_TOKENS = 500000  # Reduced evaluation: ~100 steps instead of 320
